...
Copy the printed `tf_...` secret into a password manager. TradeForge stores only its SHA-256 hash and cannot display the secret again. Do not place the secret in Git, screenshots, shell transcripts, URLs, or issue comments.
