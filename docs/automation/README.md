...
| --- | --- | --- |
| CI | Pull request and push to `main` | Checks Ruff and lock drift, treats test warnings as failures, tests Python 3.11 and 3.13, builds the package, starts and health checks the container, then publishes to GHCR after a successful `main` build. |
